...
class FileSelector(Frame):
    ...
    def __init__(self, master=None, **kwargs):
        ...
        self.folder_frame = Frame(self, bg='#2b2d35')

        self.files_view = Listbox(self, width=65, height=20, bg='#23242a', fg='white', 
                                 selectbackground='#44475a', selectforeground='white',
                                 highlightbackground='#2b2d35', highlightcolor='#6272a4', highlightthickness=1)
        self.folder_entry = Entry(self.folder_frame, width=58,
                  textvariable=self.base_dir, bg='#23242a', fg='white', 
                  insertbackground='white', highlightbackground='#2b2d35', 
                  highlightcolor='#6272a4', highlightthickness=1)
    ...
    def create_widgets(self):
        ...
        pad_y = 5
        pad_x = 10
        Label(self, text="Images", font=14, bg='#2b2d35', fg='white').pack()
        # List for files
        self.files_view.pack(pady=pad_y, padx=pad_x)

        # Folder entry field
        Label(self.folder_frame, text="Folder:", bg='#2b2d35', fg='white').pack(side=LEFT)
        self.folder_entry.pack(side=RIGHT, pady=pad_y)

        # Button panel and error message
        Button(self.button_frame, text="Choose folder",
         command=self.fill_list, bg='#44475a', fg='white', activebackground='#6272a4', activeforeground='white').pack(side=LEFT, padx=pad_x)

        Button(self.button_frame, text="Choose file(s)",
         command=self.select_files, bg='#44475a', fg='white', activebackground='#6272a4', activeforeground='white').pack(side=LEFT)

        Button(self.button_frame, text="Clear files",
         command=self.clear_files, bg='#44475a', fg='white', activebackground='#6272a4', activeforeground='white').pack(side=RIGHT)

        Button(self.button_frame, text="Remove file",
         command=self.remove_item, bg='#44475a', fg='white', activebackground='#6272a4', activeforeground='white').pack(side=RIGHT, padx=pad_x)
